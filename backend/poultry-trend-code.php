...
if (isset($_POST['savedata'])) {
    ...
    try {
        $insert_query = "INSERT INTO poultry_trend (poultry_year, layers_count, broiler_count, native_count, fighting_count,
    ...
    $update_query = "UPDATE poultry_trend SET layers_count=?, broiler_count=?, native_count=?, fighting_count=?, date_updated=? WHERE poultry_year=?";
    ...
    $delete_query = "DELETE FROM poultry_trend WHERE poultry_year='$id'";
