        ...
        <div>
            ...
            <div class="nav__list">
                <div class="nav__items">
                    ...
                    <div class="nav__dropdown show" id="healthDropdown">
                        <a href="#" class="nav__link active" onclick="toggleDropdown('healthDropdown')">
                        ...
                        <div class="nav__dropdown-collapse">
                            <div class="nav__dropdown-content">
                                ...
                                <a href="/benguetlivestock/frontend/veterinary-clinics.php"
                                    class="nav__dropdown-item active">Veterinary</a>
                            </div>
                        </div>
                    </div>
                </div>
