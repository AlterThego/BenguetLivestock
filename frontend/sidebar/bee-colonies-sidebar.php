...
<header class="header">
    <div class="header__container">
        <img src="/benguetlivestock/assets/images/logo.png" alt="" class="header__img">

        <a href="#" class="header__logo">Benguet Animals and Agriculture</a>
                ...
                <div class="nav__items">
                    ...
                    <div class="nav__dropdown" id="animalsDropdown">
                        <a href="#" class="nav__link" onclick="toggleDropdown('animalsDropdown')">
                            <svg xmlns="/benguetlivestock/assetes/images/animal.svg" class='bx nav__icon' width="20"
                        ...
                        <div class="nav__dropdown-collapse">
                            <div class="nav__dropdown-content">
                                <a href="/benguetlivestock/frontend/pets-population.php"
                                    class="nav__dropdown-item">Population</a>
                                <a href="/benguetlivestock/frontend/pet-trend.php" class="nav__dropdown-item">Trend</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="nav__dropdown show" id="beekeepingDropdown">
                        <a href="#" class="nav__link active" onclick="toggleDropdown('beekeepingDropdown')">
                        ...
                        <div class="nav__dropdown-collapse">
                            <div class="nav__dropdown-content">
                                <a href="/benguetlivestock/frontend/bee-colonies.php"
                                    class="nav__dropdown-item active">Beekeepers and Colonies</a>
                    ...
                    <div class="nav__dropdown" id="breedingDropdown">
                        <a href="#" class="nav__link" onclick="toggleDropdown('breedingDropdown')">
                            <svg xmlns="http://www.w3.org/2000/svg" class='bx nav__icon' viewBox="0 0 32 32" width="20"
                                height="20">
                                <path fill="currentColor"
