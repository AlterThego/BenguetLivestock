        ...
        <div>
            ...
            <div class="nav__list">
                ...
                <div class="nav__items">
                    ...
                    <div class="nav__dropdown show" id="animalsDropdown">
                        <a href="#" class="nav__link active" onclick="toggleDropdown('animalsDropdown')">
                        ...
                        <div class="nav__dropdown-collapse">
                            <div class="nav__dropdown-content">
                                <a href="/benguetlivestock/frontend/animal-population.php"
                                    class="nav__dropdown-item active">Population</a>
