        ...
        <div>
            ...
            <div class="nav__list">
                ...
                <div class="nav__items">
                    ...
                    <div class="nav__dropdown show" id="breedingDropdown">
                        <a href="#" class="nav__link active" onclick="toggleDropdown('breedingDropdown')">
                        ...
                        <div class="nav__dropdown-collapse">
                            <div class="nav__dropdown-content">
                                ...
                                <a href="/benguetlivestock/frontend/commercial-poultry.php"
                                    class="nav__dropdown-item active">Commercial Farms</a>
