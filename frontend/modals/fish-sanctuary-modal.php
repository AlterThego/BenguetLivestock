                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="id-name">
                            ...
                            $existing_ids_query = "SELECT DISTINCT barangay_id FROM fishsanctuary";
                            $existing_ids_result = mysqli_query($connection, $existing_ids_query);

                            $existing_ids = [];
                            while ($existing_row = mysqli_fetch_array($existing_ids_result)) {
                                $existing_ids[] = $existing_row['barangay_id'];
                            }

                            $fetch_types_query = "SELECT * FROM kapanganbarangay ORDER BY barangay_id ASC";
                            ...
                            while ($type_row = mysqli_fetch_array($fetch_types_query_run)) {
                                ...
                                if (!in_array($type_row['barangay_id'], $existing_ids)) {
                                    // Do not use htmlspecialchars here
                                    $option_value = $type_row['barangay_id'] . " - " . $type_row["barangay_name"];
...
<div class="modal fade" id="submitTotalModal" tabindex="-1" role="dialog" aria-labelledby="submitTotalModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="/benguetlivestock/backend/fish-sanctuary-code.php">
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="fishYear">Year</label>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            <input type="hidden" name="totalArea" value="<?php echo $totalArea; ?>">
                        </tfoot>
                    </table>
        ...
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/fish-sanctuary-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="update_area_yearly">Area</label>
                        <input type="number" class="form-control" name="update_area_yearly" id="update_area_yearly" ?>
                    </div>
