...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/animal-deaths-code.php" method="POST">
                <!-- Body -->
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="zip">
                            ...
                            $existing_ids_query = "SELECT DISTINCT municipality_id FROM animaldeaths";
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" name="death_count"
                            placeholder="Enter Animal Death Count">
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="../backend/animal-deaths-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="update_death_count">Death Count</label>
                        <input type="number" class="form-control" name="update_death_count" id="update_death_count">
                    </div>
...
<div class="modal fade" id="submitTotalModal" tabindex="-1" role="dialog" aria-labelledby="submitTotalModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="/benguetlivestock/backend/animal-deaths-code.php">
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="deathYear">Year</label>
                        <input type="number" class="form-control" name="deathYear" value="<?php echo date('Y'); ?>"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            <input type="hidden" name="totalAnimalDeaths" value="<?php echo $totalAnimalDeaths; ?>">
                        </tfoot>
                    </table>
        ...
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/animal-deaths-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="update_deaths_yearly">Deaths</label>
                        <input type="number" class="form-control" name="update_deaths_yearly" id="update_deaths_yearly"
                            ?>
                    </div>
