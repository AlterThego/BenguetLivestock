...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/common-diseases-code.php" method="POST">
                <!-- Body -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="id-name">
                            ...
                            $existing_ids_query = "SELECT DISTINCT disease_id FROM commondiseases";
                            $existing_ids_result = mysqli_query($connection, $existing_ids_query);

                            $existing_ids = [];
                            while ($existing_row = mysqli_fetch_array($existing_ids_result)) {
                                $existing_ids[] = $existing_row['disease_id'];
                            }

                            $fetch_types_query = "SELECT * FROM animaldiseases ORDER BY disease_id ASC";
                            ...
                            while ($type_row = mysqli_fetch_array($fetch_types_query_run)) {
                                ...
                                if (!in_array($type_row['disease_id'], $existing_ids)) {
                                    // Do not use htmlspecialchars here
                                    $option_value = $type_row['disease_id'] . " - " . $type_row["disease_name"];
            ...
            <form action="../backend/common-diseases-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="update_number" id="update_number">
                    </div>
...
<div class="modal fade" id="submitTotalModal" tabindex="-1" role="dialog" aria-labelledby="submitTotalModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="/benguetlivestock/backend/common-diseases-code.php">
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="diseaseYear">Year</label>
                        <input type="number" class="form-control" name="diseaseYear" value="<?php echo date('Y'); ?>"
        ...
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/common-diseases-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="update_number_yearly">Area</label>
