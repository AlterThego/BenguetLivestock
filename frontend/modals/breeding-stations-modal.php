        ...
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/breeding-stations-code.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="station_number">Number</label>
        ...
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/breeding-stations-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="update_latrinidad">La Trinidad</label>
                        <input type="number" class="form-control" name="update_latrinidad" id="update_latrinidad" ?>
                    </div>

                    <div class="form-group mb-3">
                        <label for="update_tuba">Tuba</label>
