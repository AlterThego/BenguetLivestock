...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/veterinary-clinics-code.php" method="POST">
                <!-- Body -->
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="zip">
                            ...
                            $existing_ids_query = "SELECT DISTINCT municipality_id FROM governmentveterinaryclinics";
                    ...
                    <div class="form-group mb-3">
                        <label for="clinics_count">Number</label>
                        <input type="number" class="form-control" name="clinics_count"
                            placeholder="Enter Number of Veterinary Clinics">
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="../backend/veterinary-clinics-code.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="update_clinics_count">Number</label>
                        <input type="number" class="form-control" name="update_clinics_count" id="update_clinics_count">
                    </div>
...
<!-- Add Modal Secondary -->
<div class="modal fade" id="addPrivateModal" tabindex="-1" role="dialog" aria-labelledby="addPrivateModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addPrivateModalLabel">Add data</h5>
                <button type="button " class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="/benguetlivestock/backend/veterinary-clinics-code.php" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="zip">
                            ...
                            // Modify the query to exclude existing municipality_id values
                            $existing_ids_query = "SELECT DISTINCT municipality_id FROM privateveterinaryclinics";
                            $existing_ids_result = mysqli_query($connection, $existing_ids_query);
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" name="saveprivatedata" class="btn btn-primary">Save changes</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="/benguetlivestock/backend/veterinary-clinics-code.php" method="POST">
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label for="update_private_name">ZIP Code and Municipality</label>
                        <input type="text" class="form-control" name="update_private_name" id="update_private_name"
                            readonly>
                    </div>

                    <div class="form-group mb-3">
                        <label for="update_private_clinics_count">Number</label>
                        <input type="number" class="form-control" name="update_private_clinics_count"
                            id="update_private_clinics_count">
                    </div>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="update_private_id" id="update_private_id">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
