<?php include '../backend/compare-code.php'; ?>
...
<body>
    <div class="wrapper">
        <!-- Sidebar -->
        <?php include_once '../frontend/sidebar/compare-sidebar.php'; ?>
        ...
        <script src="/benguetlivestock/assets/js/content-js/compare-script.js"></script>
