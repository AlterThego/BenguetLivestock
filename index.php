<?php include './backend/index-code.php'; ?>
...
<body>
    <div class="wrapper">
        <!-- Sidebar -->
        <?php include_once './frontend/sidebar/index-sidebar.php'; ?>
            ...
            <div class="container-fluid">
                <div class="card text-center">
                    ...
                    <div class="row pl-3">
                        ...
                        <?php include './backend/index-comparison-code.php'; ?>
        ...
        <script src="/benguetlivestock/assets/js/content-js/index-script.js"></script>
</body>
